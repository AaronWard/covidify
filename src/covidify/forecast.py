...
class IBuilder(metaclass=ABCMeta):
    @staticmethod
    def plot_forecast():
        "plotting forecast into file"

    @staticmethod
    def forecast():
        "forecasting and saving data"

class Builder(IBuilder):
    def __init__(self):
        self.product = Product()

    def plot_forecast(self, tmp_df, train, index_forecast, forecast, confint):
        '''
    ...
    def forecast(self, tmp_df, train, index_forecast, days_in_future):
...
class Product():
    def __init__(self):
        "initialize to empty"
        self.forecast = pd.DataFrame(data=None, index=None, columns=None, dtype=None, copy=None)

class Director():
    @staticmethod
    def construct():
        return Builder()\
        .forecast(pd.DataFrame(data=None, index=None, columns=None, dtype=None, copy=None), train, index_forecast, days_in_future)