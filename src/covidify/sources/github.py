...
class Github(DataInterface):
    ...
    def __init__(self):
        ...
        if Github.__instance is not None:
            raise Exception("This is a singleton class, please use the get_instance function")
        else:
            # Create Tmp Folder
            ...
            Github.data = get_data(cleaned_sheets)
            Github.__instance = self
